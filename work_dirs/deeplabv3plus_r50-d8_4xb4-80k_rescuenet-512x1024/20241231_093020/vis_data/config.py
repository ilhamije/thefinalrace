...
model = dict(
    ...
    pretrained=
    'pretrained/deeplabv3plus/deeplabv3plus_r50-d8_512x1024_80k_cityscapes_20200606_114049-f9fb496d.pth',
...
work_dir = './work_dirs/deeplabv3plus_r50-d8_4xb4-80k_rescuenet-512x1024'
