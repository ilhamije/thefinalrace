...
def process_work_dirs(base_path, layer_name):
...
# Base path to work_dirs
# Replace with the actual base path to your work_dirs
base_path = "/workspace/thefinalrace/work_dirs"
# Replace with the layer name you want to inspect
layer_name = "backbone.conv1.weight"

# Run the process
process_work_dirs(base_path, layer_name)
