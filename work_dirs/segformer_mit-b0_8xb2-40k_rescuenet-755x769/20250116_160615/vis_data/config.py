...
default_hooks = dict(
    ...
    logger=dict(interval=400, log_metric_by_epoch=False, type='LoggerHook'),
...
launcher = 'none'
load_from = 'work_dirs/segformer_mit-b0_8xb2-40k_rescuenet-755x769/iter_40000.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/segformer_mit-b0_8xb2-40k_rescuenet-755x769'
