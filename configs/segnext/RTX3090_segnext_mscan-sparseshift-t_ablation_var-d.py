# RTX3090_segnext_mscan-sparseshift-t_ablation_var-d.py

_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_20k.py',
    '../_base_/datasets/rescuenet_512x512.py'  # Will override augment
]
...
model = dict(
    ...
    backbone=dict(
        ...
        act_cfg=dict(type='ReLU'),  # ReLU instead of GELU
...
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',  # No AMP for now
    optimizer=dict(
