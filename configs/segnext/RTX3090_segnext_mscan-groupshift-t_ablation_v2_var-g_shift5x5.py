...
model = dict(
    ...
    backbone=dict(
        ...
        # shift_offsets=[(i, j) for i in range(-2, 3)
        #                for j in range(-2, 3)],  # total 25 shifts
        shift_offsets=[
            (-2, 0), (-1, 0), (0, 0), (1, 0), (2, 0),      # vertical line
            (0, -2), (0, -1), (0, 1), (0, 2),              # horizontal line
            (1, 1), (1, -1), (-1, 1), (-1, -1),            # inner diagonals
            # fewer outer diagonals
            (2, 2), (-2, -2), (0, 0)
        ],
